...
namespace cv{
    ...
    void dilate(Mat img, Mat &dilated, Mat se, _Position center = {0,0}){
    ...
    void erode(Mat img, Mat &eroded, Mat se, _Position center = {0,0}){
...
int main() {
    ...
    cv::dilate(image, dst_img, structuringElement, {1, 0});
    cout << dst_img;
}
